      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              MERN stack developer with 6 years of experience in designing and
              developing dynamic web applications. Proficient in MongoDB,
              Express.js, React, and Node.js, with a strong foundation in
              front-end and back-end development. Experienced in working with
              various development tools and frameworks, implementing RESTful
              APIs, and collaborating in agile environments. Dedicated to
              continuously improving skills and delivering high-quality,
              scalable solutions.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
              As a passionate and dedicated MERN stack developer with six years
              of experience, I strive to push the boundaries of web application
              development. My journey is fueled by a relentless pursuit of
              excellence and a commitment to delivering innovative, high-quality
              solutions that drive success for businesses and delight users.
              With a robust foundation in MongoDB, Express.js, React, and
              Node.js, I continuously seek to learn, grow, and transform
              challenges into opportunities, all while collaborating with
              like-minded professionals in agile environments. My mission is to
              create impactful digital experiences that not only meet but exceed
              expectations.
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I spearheaded React-based application development and
                    headless cms, leveraging advanced skills.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    Sept 2018 - Nov 2021{" "}
